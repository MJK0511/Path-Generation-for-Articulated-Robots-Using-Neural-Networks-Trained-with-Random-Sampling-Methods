...
class ExtractWaypoint:
    ...
    def trainDF(self, input_path):
        all_mid = self.extract_middle(input_path)
...
if __name__ == "__main__":
    ...
    input_path = os.path.join(default_folder, 'Configuration/selected_op')
